...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fa] w-full overflow-x-hidden">
      ...
      {/* Content */}
      <main className="max-w-[1440px] mx-auto px-4 py-8  w-full flex-1 pt-35 lg:pt-35">
        {loading ? (
          <Loading />
        ) : !data || data.total === 0 ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: 300, gap: 12, color: "#bbb", textAlign: "center" }}>
            ...
            <p style={{ fontSize: "1rem" }}>No sign ups yet.</p>
            <p style={{ fontSize: "0.85rem", color: "#ccc" }}>Responses will appear here once users complete sign up.</p>
          </div>
        ) : (
          <>
