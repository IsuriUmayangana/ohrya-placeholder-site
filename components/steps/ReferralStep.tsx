...
export default function ReferralStep({ referralCode, onNext }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-8 px-6 w-full max-w-lg mx-auto text-center">
      ...
      <div className="flex flex-col gap-2">
        ...
        >
          Share it with friends. Every time someone completes the survey using
          your link, you earn <strong style={{ color: "#5a9aaa" }}>+1 point</strong> on
